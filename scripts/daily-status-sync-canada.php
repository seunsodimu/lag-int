 ...
 * 
 * Usage:
 * - Via command line: php daily-status-sync-canada.php [YYYY-MM-DD]
 * - Via web browser: http://yoursite.com/scripts/daily-status-sync-canada.php?after_date=YYYY-MM-DD
 * - Via cron job: 0 9 * * * /usr/bin/php /path/to/daily-status-sync-canada.php
 * 
 * Parameters:
 * - after_date (optional): Only process orders created after this date (YYYY-MM-DD format)
 *   - Command line: php daily-status-sync-canada.php 2025-09-01
