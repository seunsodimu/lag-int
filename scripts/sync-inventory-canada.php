 ...
 * 
 * Usage:
 * - Via command line: php sync-inventory-canada.php
 * - Via web browser: http://yoursite.com/run-inventory-sync-canada.php
 * - Via cron job: 0 2 * * * /usr/bin/php /path/to/sync-inventory-canada.php
 * 
 * Parameters:
 * - limit (optional): Limit the number of products to sync in one run
 *   - Command line: php sync-inventory-canada.php --limit=50
 *   - Web browser: ?limit=50
 * - offset (optional): Start from a specific product offset (for pagination)
 *   - Command line: php sync-inventory-canada.php --offset=100
...
$syncService = new InventorySyncService('3dcart_canada');

// Log job start
$logger->info('Starting Canada inventory synchronization job', [
    'limit' => $filters['limit'],
