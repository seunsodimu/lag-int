...
if ($method === 'POST') {
    ...
    try {
        $controller = new WebhookController('3dcart_canada');
    ...
    <head>
        ...
        <title>Canada Webhook Endpoint - 3DCart Integration</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>🇨🇦 Canada Webhook Endpoint</h1>
                <p>Canada 3DCart Order Processing Webhook</p>
            </div>
