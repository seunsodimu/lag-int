...
// Initialize services
$syncService = new OrderStatusSyncService('3dcart_canada');
$threeDCartService = new ThreeDCartService('3dcart_canada');
$netSuiteService = new NetSuiteService();
$webhookController = new WebhookController('3dcart_canada');
...
<head>
    ...
    <title><?php echo $config['app']['name']; ?> - Canada Order Status Manager</title>
    <style>
        body {
...
<body>
    ...
    <script>
        ...
        function searchOrder() {
            ...
            fetch('order-status-manager-canada.php', {
                method: 'POST',
                headers: {
            ...
            let html = `
                <div class="field-row">
                    ...
                    <span class="field-value">
                     ${order.OrderID ? `<a href="https://www.lagunaportalca.com/admin/order_details.asp?orderid=${order.OrderID}" target="_blank">${order.OrderID}</a>` : 'N/A'}</span>
                    </span>
                </div>
                <div class="field-row">
