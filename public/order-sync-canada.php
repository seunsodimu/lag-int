...
<head>
    ...
    <title>Canada Order Synchronization - <?php echo $config['app']['name']; ?></title>
        ...
        <div class="row">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1><i class="fas fa-sync-alt me-2"></i>Canada Order Synchronization</h1>
            ...
            tbody.innerHTML = orders.map(order => {
                ...
                if (order.can_sync) {
                    actions = `
                        ...
                        <div>
                            <a href="order-status-manager-canada.php?order_id=${order.order_id}" target="_blank">
